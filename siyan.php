...
<head>
    <meta name="keywords" content="雅漾红血丝修护,灼热泛红" />
    <meta name="description" content="雅漾红血丝修护系列全新推出一款抗红血丝修护产品——雅漾修红舒润面膜，该产品不含香料，不含对羟基苯甲酸脂，适用于各种敏感肌肤的灼热、泛红及红血丝现象。" />
    <title>雅漾修红舒润面膜_修红保湿系列__雅漾AVENE官方网站</title>
    <?php
    include('./header.php');
    ?>
</head>
...
<div class="page" data-style="opacity:0" data-animate="opacity:1" data-delay="1000" data-time="400" data-easing="easeInOutQuart">
    ...
    <div class="siyan_img siyan_qa1" data-0="opacity:0;margin-top:-50px;" data-300="opacity:1;margin-top:0;">
        ...
        <p class="text">我本身是雅漾的忠实粉丝，雅漾能选择我作为全新的品牌大使，我感到非常荣幸。在怀孕期间其实皮肤非常容易过敏，但我一直在坚持使用雅漾的产品，我也想通过这次代言，能够跟大家分享一些我的心得体会，希望对爱美的准妈妈有所帮助。</p>
    </div>
    <div class="siyan_img siyan_qa2" data-0="opacity:0;margin-top:-50px;" data-300="opacity:1;margin-top:0;">
        ...
        <p class="text">雅漾的无刺激配方一直是它家的核心竞争力,也正因此它家的产品常伴我左右,有效地帮助我抗击过敏原,舒缓肌肤。现在雅漾又推出了“ 无菌护肤 ”的全新理念,全程无菌令抗敏养护更安心。</p>
    </div>
    <!--  -->
    <div class="siyan_tj">
        <h3 class="tit">［霍思燕的爱用推荐］</h3>
        <p class="text"><span>与霍思燕聊起其挚爱推荐,她示意了下化妆台上的瓶瓶罐罐——雅漾舒缓特护系列+修红系列。她说这两个系列都是她的抗敏法宝,亦为敏感人群特别定制的护肤优品。舒缓特护系列精简安全配方,纯净无菌灌装,取自天然的活性为肌肤注入持久舒缓的滋养力量。而说起霍思燕的挚爱 单品应该当数舒缓特护面霜,无菌乳霜在舒缓肌肤时更持 久滋养,是高度敏感肌必不可少的滋养佳品。</span>
        <span>演员的特殊性令她上妆卸妆的频次较高,反复摩擦肌肤令两颊部分会出现泛红等症状,而这套修红舒润面膜更像是为有这一困扰的肌肤而生,帮助修护角质层,收缩过度扩张的毛细 血管,缓解敏感泛红肌肤,给予敏感肌肤细致入微的呵护。</span></p>
    </div>
    <div class="siyan_avene"> </div>
</div>
<!--  -->
<?php
    include('./footer.php');
