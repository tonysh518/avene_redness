...
<div class="page" data-style="opacity:0" data-animate="opacity:1" data-delay="1000" data-time="400" data-easing="easeInOutQuart">
    ...
    <div class="repair_imgtit repair_summary">
        <p class="text">在中国约有46％的都市女性受到不同程度的面部敏感困扰，并伴有泛红现象。</p>
    </div>
    <!-- part1 -->
    <div class="repair_imgtit repair_pt1tit" data-style="opacity:0" data-animate="opacity:1" data-delay="1000" data-time="400" data-easing="easeInOutQuart">
        <h3 class="tit">PART 1  敏感泛红灼热自测</h3>
    </div>
    <div class="repair_imgpt1 repair_pt1txt" data-style="opacity:0" data-animate="opacity:1" data-delay="1300" data-time="400" data-easing="easeInOutQuart">
        <p class="text">你是否怀疑自己有敏感泛红?来试着做个自测吧！<br />在符合你的症状前进行勾选,每勾一个加10分,看看你的敏感泛红状况到底有几分。</p>
    </div>
